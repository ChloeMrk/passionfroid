...
<div class="wrap">
    ...
    <div class="box">
      <div class="boxInner">
        <img src="https://res.cloudinary.com/instagrambisphp/image/upload/v1614074623/frqr5dth7tjpyefvrfcy.jpg" />
        <div class="titleBox">Butterfly</div>
      </div>
    </div>
    <div class="box">
      <div class="boxInner">
        <img src="https://res.cloudinary.com/instagrambisphp/image/upload/v1614074626/vyvpjbglc4qpjagxbnst.jpg" />
        <div class="titleBox">An old greenhouse</div>
      </div>
    </div>
    <div class="box">
      <div class="boxInner">
        <img src="https://res.cloudinary.com/instagrambisphp/image/upload/v1614074638/hlyl4daaxe9sv0ds2rob.jpg" />
        <div class="titleBox">Purple wildflowers</div>
      </div>
    </div>
    <div class="box">
      <div class="boxInner">
        <img src="https://res.cloudinary.com/instagrambisphp/image/upload/v1614074647/g9fhs4eywzovun842bqj.jpg" />
        <div class="titleBox">A birdfeeder</div>
      </div>
    </div>
    <div class="box">
      <div class="boxInner">
        <img src="https://res.cloudinary.com/instagrambisphp/image/upload/v1614074635/vhemaoz2hitfwokcqgzp.jpg" />
        <div class="titleBox">Crocus close-up</div>
      </div>
    </div>
    <div class="box">
      <div class="boxInner">
        <img src="https://res.cloudinary.com/instagrambisphp/image/upload/v1614074642/r12aaacq8fuqwuqn1bvl.jpg" />
        <div class="titleBox">The garden shop</div>
      </div>
    </div>
    <div class="box">
      <div class="boxInner">
        <img src="https://res.cloudinary.com/instagrambisphp/image/upload/v1614074659/nsmtjsrcepyvcjdz5m75.jpg" />
        <div class="titleBox">Spring daffodils</div>
      </div>
    </div>
    <div class="box">
      <div class="boxInner">
        <img src="https://res.cloudinary.com/instagrambisphp/image/upload/v1614074673/inbpyw4bmd2cl9gftevp.jpg" />
        <div class="titleBox">Iris along the path</div>
      </div>
    </div>
    <div class="box">
      <div class="boxInner">
        <img src="https://res.cloudinary.com/instagrambisphp/image/upload/v1614074716/t7xbbsrmiylueeb31vdo.jpg" />
        <div class="titleBox">The garden blueprint</div>
      </div>
    </div>
    <div class="box">
      <div class="boxInner">
        <img src="https://res.cloudinary.com/instagrambisphp/image/upload/v1614074729/vt383p578mtgpo5wweui.jpg" />
        <div class="titleBox">The patio</div>
      </div>
    </div>
    <div class="box">
      <div class="boxInner">
        <img src="https://res.cloudinary.com/instagrambisphp/image/upload/v1614074725/pgjahwri2yc8aiogbvfv.jpg" />
        <div class="titleBox">Bumble bee collecting nectar</div>
      </div>
    </div>
    <div class="box">
      <div class="boxInner">
        <img src="https://res.cloudinary.com/instagrambisphp/image/upload/v1614074711/zchjn4t0atmyodpvocqq.jpg" />
  ...
  <tbody>
    @foreach ($produits as $produit)
        <tr>
          ...
          <td><img src="{{$produit->url_image}}" alt="" style = "width:50px; height:50px"></td>
          <td class="odd"><a href="{{route('modification.produit',['id'=>$produit->id])}}">Modifier</td>
